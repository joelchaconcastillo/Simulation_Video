...
ObjectivesFiles = ['Sample_Visual_Video/VSD_MOEA_V1_obj','Sample_Visual_Video/NSGAII_obj', 'Sample_Visual_Video/GDE3_obj', 'Sample_Visual_Video/MOEAD_obj', 'Sample_Visual_Video/SMSEMOA_obj', 'Sample_Visual_Video/MOMBI2_obj', 'Sample_Visual_Video/VSD_MOEAD_obj']
VariablesFiles = ['Sample_Visual_Video/VSD_MOEA_V1_var','Sample_Visual_Video/NSGAII_var', 'Sample_Visual_Video/GDE3_var', 'Sample_Visual_Video/MOEAD_var', 'Sample_Visual_Video/SMSEMOA_var','Sample_Visual_Video/MOMBI2_var', 'Sample_Visual_Video/VSD_MOEAD_var']


names = ['VSD-MOEA', 'NSGA-II', 'GDE3', 'MOEA\D', 'SMS-EMOA', 'MOMBI-II', 'VSD-MOEA/D']
colr =['blue', 'red','green','magenta', 'cyan', 'gray', 'black']
...
i = 0
for NameFile in ObjectivesFiles:
	individualsObj[NameFile], = ObjectiveSpace.plot([], [], Colours[i], ms=7)
	i = i+1
i = 0
for NameFile in VariablesFiles:
	individualsVar[NameFile], = VariableSpace.plot([], [], Colours[i], ms=7)
	i = i+1
...
def init():
    ...
    return individualsObj['Sample_Visual_Video/VSD_MOEA_V1_obj'], individualsObj['Sample_Visual_Video/NSGAII_obj'], individualsObj['Sample_Visual_Video/GDE3_obj'], individualsObj['Sample_Visual_Video/MOEAD_obj'], individualsObj['Sample_Visual_Video/SMSEMOA_obj'], individualsObj['Sample_Visual_Video/MOMBI2_obj'], individualsObj['Sample_Visual_Video/VSD_MOEAD_obj'] ,individualsVar['Sample_Visual_Video/VSD_MOEA_V1_var'],individualsVar['Sample_Visual_Video/NSGAII_var'],individualsVar['Sample_Visual_Video/GDE3_var'],individualsVar['Sample_Visual_Video/MOEAD_var'], individualsVar['Sample_Visual_Video/SMSEMOA_var'], individualsVar['Sample_Visual_Video/MOMBI2_var'],individualsVar['Sample_Visual_Video/VSD_MOEAD_var'], time_textObj, time_textVar,
